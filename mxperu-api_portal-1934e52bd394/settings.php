 ...
 *
 * This file was automatically generated by Aegir 7.x-3.9
 * on Wed, 24 Jun 2020 02:00:09 +0000.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  $profile = "apim_profile";
  $install_profile = "apim_profile";
  ...
  */
  ...
  global $conf;
  $conf['install_profile'] = 'apim_profile';
  $conf['file_public_path'] = 'sites/int.development.developerportalv5.bancolombia.corp/files';
  $conf['file_private_path'] = 'sites/int.development.developerportalv5.bancolombia.corp/private/files';
  $conf['file_temporary_path'] = 'sites/int.development.developerportalv5.bancolombia.corp/private/temp';
  $drupal_hash_salt = '';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 3;
...
# Extra configuration from modules:
  ...
  if (is_readable('/var/aegir/platforms/devportal-7.x-5.0.8.7-iFix-20200116-2206/sites/int.development.developerportalv5.bancolombia.corp/local.settings.php')) {
    include_once('/var/aegir/platforms/devportal-7.x-5.0.8.7-iFix-20200116-2206/sites/int.development.developerportalv5.bancolombia.corp/local.settings.php');
  }
